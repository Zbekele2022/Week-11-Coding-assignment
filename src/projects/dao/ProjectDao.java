...
public class ProjectDao extends DaoBase {
  ...
  /**
   * modify project details at this section.
   * 
   * @param project The project object to modify.
   * @return The Project object with the primary key.
   * @throws DbException Thrown if an error occurs modifying the project details.
   */
        ...
        try(ResultSet rs = stmt.executeQuery()) {
          ...
          while(rs.next()) {
            ...
            Project project = new Project();
             ...
             project.setproject_ID(rs.getObject("project_ID", Integer.class));
...
//          project.getMaterial().addAll(fetchMaterialsForProject(conn, project_ID));
//          project.getStep().addAll(fetchStepsForProject(conn, project_ID));
//          project.getCategory().addAll(fetchCategoriesForProject(conn, project_ID));
//        }
//
//        commitTransaction(conn);
//
...
//  }
   ...
   */
  private List<Category> fetchCategoriesForProject(Connection conn, Integer project_ID) {
    // @formatter:off
    String sql = ""
   ...
   */
  private List<Step> fetchStepsForProject(Connection conn, Integer project_ID) throws SQLException {
   ...
   * @throws SQLException Thrown if the database driver encounters an error.
   */
  private List<Material> fetchMaterialsForProject(Connection conn, Integer project_ID)
      throws SQLException {
