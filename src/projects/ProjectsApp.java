...
public class ProjectsApp {
  ...
  private projects.Services.ProjectService projectService = new projects.Services.ProjectService();
  ...
  private void deletetProject() {
	...
	if(Objects.nonNull(curProject) && curProject.getproject_ID().equals(Project_ID)) {
	curProject= null;
		}
...
/**
  ...
  private void listProjects() {
    ...
    projects.forEach(project -> System.out
        .println("   " + project.getproject_ID() + ": " + project.getProjectName()));
  }
